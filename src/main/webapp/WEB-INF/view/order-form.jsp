...
<html>
<head>
    <h2>Order a new flight ticket(s)</h2>
</head>
<body>
<form:form action="ordering" modelAttribute="flight" method="post">
    <form:hidden path="id"/>
    <table>
        <tbody>
        <tr>
        ...
        <tr>
            <td><label>Choose the amount of tickets:</label></td>
            <td><form:input type="number" path="orderFlight.amount"/></td>
        </tr>
        <tr>
            <td><input type="submit" value="Order" class="save"/></td>
        </tr>
        </tbody>
    </table>
